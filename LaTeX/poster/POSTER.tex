...
\textbf{Introduction} \\
Bluetooth is a wireless communications technology for short-medium range data
transfer
...
\textbf{Adaptive Frequency Hopping}
Bluetooth uses a technique called adaptive frequency hopping, which is explained on the left side of this poster.
}
