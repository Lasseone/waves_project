...
\textcolor{blue}{ 
\textbf{What is Wi-Fi}
 Wi-Fi is defined as any “wireless local area network (WLAN) products that are based on the IEEE 802.11 standards.". Wi-Fi is usually a wave of frequency between 2.4GHz to 5GHz.}
\textbf{Uses}
...
\textbf{Advantages}
•	The wireless nature of Wi-Fi networks are convenient
•	Users connected even when moving around
