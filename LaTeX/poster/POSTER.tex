...
•	Slow speed compared to wired connection
}
...
\textbf{Principle} A light emitter modulates light intensity while a photo detector receives the signal and converts it back to an electrical data stream. 
